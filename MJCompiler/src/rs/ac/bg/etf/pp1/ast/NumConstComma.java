...
public class NumConstComma extends ConstDecl {
    ...
    public NumConstComma (Const Const, Type Type, String constName, Integer constVal, ConstDeclList ConstDeclList) {
        this.Const=Const;
