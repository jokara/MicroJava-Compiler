...
public class MyDStatementWithPars extends DesignatorStatement {

    private FactorDesignator FactorDesignator;
    private ActualPars ActualPars;

    public MyDStatementWithPars (FactorDesignator FactorDesignator, ActualPars ActualPars) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("MyDStatementWithPars(\n");
