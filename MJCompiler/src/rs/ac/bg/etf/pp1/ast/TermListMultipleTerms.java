...
public class TermListMultipleTerms extends TermList {

    private TermList TermList;
    private Addop Addop;
    private Term Term;

    public TermListMultipleTerms (TermList TermList, Addop Addop, Term Term) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("TermListMultipleTerms(\n");
