...
public class CharConstComma extends ConstDecl {
    ...
    public CharConstComma (Const Const, Type Type, String constName, Character constVal, ConstDeclList ConstDeclList) {
        this.Const=Const;
